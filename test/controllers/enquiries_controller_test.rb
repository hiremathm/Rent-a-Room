...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { description: @enquiry.description, email: @enquiry.email, subject: @enquiry.subject }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { description: @enquiry.description, email: @enquiry.email, subject: @enquiry.subject }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
